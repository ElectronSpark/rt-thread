...
static struct ra6m4_pwm ra6m4_pwm_obj[BSP_PWMS_NUM] = 
{
...
static rt_err_t drv_pwm_enable(struct ra6m4_pwm *device, 
...
/* PWM_CMD_GET */
static rt_err_t drv_pwm_get(struct ra6m4_pwm *device, 
                            struct rt_pwm_configuration *configuration)
{
    timer_info_t info;
...
/* PWM_CMD_SET */
static rt_err_t drv_pwm_set(struct ra6m4_pwm *device, 
...
static rt_err_t drv_pwm_control(struct rt_device_pwm *device, int cmd, void *arg)
{
    ...
    struct ra6m4_pwm *pwm_device = (struct ra6m4_pwm *)device->parent.user_data;
